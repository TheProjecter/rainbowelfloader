...
f_SEEM_ELEMENT_DATA_write SEEM_ELEMENT_DATA_write = ( f_SEEM_ELEMENT_DATA_write )0x101D1BC8;
...
// обновление метки
typedef UINT8 ( *f_DL_DbShortcutUpdateRecord )( IFACE_DATA_T  *data, SEEM_0002_T  record ); //10726B4A
f_DL_DbShortcutUpdateRecord DL_DbShortcutUpdateRecord = ( f_DL_DbShortcutUpdateRecord )0x10726B4A;

// удаление метки
typedef UINT8 ( *f_DL_DbShortcutDeleteRecord )( IFACE_DATA_T  *data, UINT8 seem_rec); //10726B22
...
typedef UINT8 ( *f_DL_DbShortcutGetRecordByRecordId )( IFACE_DATA_T  *data, UINT8  seem_rec); //10726ACC
...
typedef UINT16 ( *f_DL_DbShortcutGetNumOfRecordsAvailable )( void ); //10726AF4
...
typedef UINT16 ( *f_DL_DbShortcutGetNumOfRecordsUsed )( BOOL voice_shortcut ); //10726AF8
...
typedef UINT8 ( *f_DL_DbGetFirstAvailableNumber )( void ); //10726B1E
...
typedef UINT16 ( *f_DL_DbShortcutGetNumOfURLRecordsUsed )( void ); //10726C70
...
typedef UINT32 ( *f_DL_DbShortcutGetURLByURLId )( IFACE_DATA_T *data, UINT32 URLId); //10726C74
f_DL_DbShortcutGetURLByURLId DL_DbShortcutGetURLByURLId = ( f_DL_DbShortcutGetURLByURLId )0x10726C74;

// получение типа записи
typedef SC_TYPE_T ( *f_DL_DbShortcutGetshortcutType )( UINT8 index ); //10726CCA
...
typedef UINT16 ( *f_DL_DbShortcutGetNumOfURLRecordsAvailable )( void ); //10726CD2
